...
//singleton class
class StakingPoolNFT extends base_smart_contract_1.SmartContract {
    ...
    async unstake_without_send(nft_contract_id, token_id) {
        return nearAPI.transactions.functionCall("unstake", {
            nft_contract_id,
            token_id
        }, new bn_js_1.BN((0, conversions_1.TGas)(200)), new bn_js_1.BN(1));
    }
    ...
    unstake(nft_contract_id, token_id) {
        return this.call("withdraw_boost_nft", { /*nft_contract_id, token_id*/}, (0, conversions_1.TGas)(125), "1");
    }
...
exports.StakingPoolNFT = StakingPoolNFT;
